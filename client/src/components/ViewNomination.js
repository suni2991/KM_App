...
function ViewNomination() {
  ...
  const handleTrainingStatusChange = (trainingId, newStatus) => {
    const trainingIndex = nominationData.trainings.findIndex(
    ...
    fetch(
      `http://localhost:6001/nominations/${nominationData._id}/trainings/${trainingId}`,
      {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  return (
    <div className="table-container">
      ...
      >
        Employee Nomination Details - {nominationData.fullName}
      </h1>
      ...
      <p>
        <b>Manager Name: </b>
        {nominationData.mgrName}
      </p>
      <p>
        <b>Manager Email: </b>
        {nominationData.mgrEmail}
      </p>
