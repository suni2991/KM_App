...
import RegistrationTabs from './components/RegistrationTabs.js';
import Bootcamps from './pages/Bootcamp.js';
import AddBootcamp from './components/AddBootcamp.js';
import ViewBootcamp from './components/ViewBootcamp.js';
import EditBootcamp from './components/EditBootcamp.js';
        ...
        <Routes>
          ...
          <Route path='/register' element={<RegistrationTabs />} />
           ...
           <Route path='/addBootcamp' element={<AddBootcamp />} />
            ...
            <Route path='/viewBootcamp/:email' element={<ViewBootcamp/>} />
            <Route path='/editBootcamp/:email' element={<EditBootcamp />} />
